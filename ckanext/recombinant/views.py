...
@recombinant.route('/recombinant/<resource_name>/<owner_org>/activity', methods=['GET'])
def activity(resource_name, owner_org):
    if not g.user:
        return h.redirect_to('user.login')
    ...
    return package_activity(id=dataset.get('id'))
